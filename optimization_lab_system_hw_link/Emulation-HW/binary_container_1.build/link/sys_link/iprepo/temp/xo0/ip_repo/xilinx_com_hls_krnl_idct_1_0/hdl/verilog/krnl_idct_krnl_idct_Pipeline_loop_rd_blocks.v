...
module krnl_idct_krnl_idct_Pipeline_loop_rd_blocks (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [511:0] gmem1_addr_read_reg_143;
...
wire   [0:0] icmp_ln223_fu_110_p2;
reg    ap_condition_pp0_exit_iter0_state71;
wire  signed [63:0] sext_ln174_1_cast_fu_91_p1;
reg   [1:0] i_fu_56;
wire   [1:0] add_ln223_fu_116_p2;
...
always @ (posedge ap_clk) begin
    if ((~((ap_start == 1'b0) | (m_axi_gmem1_ARREADY == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        i_fu_56 <= 2'd0;
    end else if (((icmp_ln223_fu_110_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if ((icmp_ln223_fu_110_p2 == 1'd1)) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((icmp_ln223_fu_110_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) & ~((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((icmp_ln223_fu_110_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
...
assign add_ln223_fu_116_p2 = (i_fu_56 + 2'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((ap_enable_reg_pp0_iter2 == 1'b1) & (iq_full_n == 1'b0)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_gmem1_RVALID == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter2 == 1'b1) & (iq_full_n == 1'b0)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_gmem1_RVALID == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_enable_reg_pp0_iter2 == 1'b1) & (iq_full_n == 1'b0)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_gmem1_RVALID == 1'b0)));
end

assign ap_block_state71_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state72_pp0_stage0_iter1 = (m_axi_gmem1_RVALID == 1'b0);
end

always @ (*) begin
    ap_block_state73_pp0_stage0_iter2 = (iq_full_n == 1'b0);
end
...
assign ap_int_blocking_cur_n = iq_blk_n;

assign ap_int_blocking_n = (ap_int_blocking_cur_n & 1'b1);

assign ap_str_blocking_n = (1'b1 & 1'b1);

assign icmp_ln223_fu_110_p2 = ((i_fu_56 == 2'd2) ? 1'b1 : 1'b0);

assign iq_din = gmem1_addr_read_reg_143;

assign m_axi_gmem1_ARADDR = sext_ln174_1_cast_fu_91_p1;
...
assign sext_ln174_1_cast_fu_91_p1 = $signed(sext_ln174_1);

endmodule //krnl_idct_krnl_idct_Pipeline_loop_rd_blocks
