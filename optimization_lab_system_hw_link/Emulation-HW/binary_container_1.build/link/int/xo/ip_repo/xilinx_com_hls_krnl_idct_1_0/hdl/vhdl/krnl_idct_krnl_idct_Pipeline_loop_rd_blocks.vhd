...
entity krnl_idct_krnl_idct_Pipeline_loop_rd_blocks is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    sext_ln174_1 : IN STD_LOGIC_VECTOR (57 downto 0);
    q : IN STD_LOGIC_VECTOR (63 downto 0);
    iq_din : OUT STD_LOGIC_VECTOR (511 downto 0);
...
architecture behav of krnl_idct_krnl_idct_Pipeline_loop_rd_blocks is 
...
attribute shreg_extract : string;
    ...
    signal gmem1_addr_read_reg_143 : STD_LOGIC_VECTOR (511 downto 0);
    ...
    signal icmp_ln223_fu_110_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_condition_pp0_exit_iter0_state71 : STD_LOGIC;
    signal sext_ln174_1_cast_fu_91_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal i_fu_56 : STD_LOGIC_VECTOR (1 downto 0);
    signal add_ln223_fu_116_p2 : STD_LOGIC_VECTOR (1 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((icmp_ln223_fu_110_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
                i_fu_56 <= add_ln223_fu_116_p2;
            end if; 
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                gmem1_addr_read_reg_143 <= m_axi_gmem1_RDATA;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, m_axi_gmem1_ARREADY, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln223_fu_110_p2)
    begin
        case ap_CS_fsm is
    ...
    add_ln223_fu_116_p2 <= std_logic_vector(unsigned(i_fu_56) + unsigned(ap_const_lv2_1));
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(m_axi_gmem1_RVALID, iq_full_n, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2)
    begin
                ap_block_pp0_stage0_01001 <= (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (iq_full_n = ap_const_logic_0)) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (m_axi_gmem1_RVALID = ap_const_logic_0)));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(m_axi_gmem1_RVALID, iq_full_n, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2)
    begin
                ap_block_pp0_stage0_11001 <= (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (iq_full_n = ap_const_logic_0)) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (m_axi_gmem1_RVALID = ap_const_logic_0)));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(m_axi_gmem1_RVALID, iq_full_n, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2)
    begin
                ap_block_pp0_stage0_subdone <= (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (iq_full_n = ap_const_logic_0)) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (m_axi_gmem1_RVALID = ap_const_logic_0)));
    end process;

        ap_block_state71_pp0_stage0_iter0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state72_pp0_stage0_iter1_assign_proc : process(m_axi_gmem1_RVALID)
    begin
                ap_block_state72_pp0_stage0_iter1 <= (m_axi_gmem1_RVALID = ap_const_logic_0);
    end process;


    ap_block_state73_pp0_stage0_iter2_assign_proc : process(iq_full_n)
    begin
                ap_block_state73_pp0_stage0_iter2 <= (iq_full_n = ap_const_logic_0);
    end process;


    ap_condition_pp0_exit_iter0_state71_assign_proc : process(icmp_ln223_fu_110_p2)
    begin
        if ((icmp_ln223_fu_110_p2 = ap_const_lv1_1)) then 
    ...
    ap_int_blocking_cur_n <= (iq_blk_n);
    ...
    icmp_ln223_fu_110_p2 <= "1" when (i_fu_56 = ap_const_lv2_2) else "0";

    iq_blk_n_assign_proc : process(iq_full_n, ap_block_pp0_stage0, ap_enable_reg_pp0_iter2)
    begin
    ...
    iq_din <= gmem1_addr_read_reg_143;

    iq_write_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001)
    begin
    ...
    m_axi_gmem1_ARADDR <= sext_ln174_1_cast_fu_91_p1;
    ...
    m_axi_gmem1_WVALID <= ap_const_logic_0;
        sext_ln174_1_cast_fu_91_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(sext_ln174_1),64));
