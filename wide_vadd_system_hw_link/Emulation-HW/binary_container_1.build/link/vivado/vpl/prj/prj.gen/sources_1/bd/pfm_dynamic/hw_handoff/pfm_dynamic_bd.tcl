...
proc create_hier_cell_System_DPA { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.MONITOR_ID {krnl_vadd_1:m_axi_gmem0-DDR[0]} \
   CONFIG.TRACE_READ_ID {0} \
   CONFIG.TRACE_WRITE_ID {1} \
 ] $dpa_mon1
  set_property HDL_ATTRIBUTE.DPA_IP_FULLNAME {/krnl_vadd_1/m_axi_gmem0-DDR[0]} [get_bd_cells /System_DPA/dpa_mon1]
  ...
  set_property -dict [ list \
   ...
   CONFIG.EN_AXI_LITE {1} \
   CONFIG.MODE_SDACCEL {true} \
   CONFIG.MONITOR_ID {krnl_vadd_1:m_axi_gmem1-DDR[2]} \
   CONFIG.TRACE_READ_ID {2} \
   CONFIG.TRACE_WRITE_ID {3} \
 ] $dpa_mon2
  set_property HDL_ATTRIBUTE.DPA_IP_FULLNAME {/krnl_vadd_1/m_axi_gmem1-DDR[2]} [get_bd_cells /System_DPA/dpa_mon2]
  ...
  connect_bd_intf_net -intf_net krnl_vadd_1_m_axi_gmem0 [get_bd_intf_pins MON_M_AXI] [get_bd_intf_pins dpa_mon1/MON_M_AXI]
  connect_bd_intf_net -intf_net krnl_vadd_1_m_axi_gmem1 [get_bd_intf_pins MON_M_AXI1] [get_bd_intf_pins dpa_mon2/MON_M_AXI]
...
SLR1 aws_ddrc SLR1 aws_ddrd SLR0}}}\
  ...
  connect_bd_intf_net -intf_net krnl_vadd_1_m_axi_gmem0 [get_bd_intf_pins krnl_vadd_1/m_axi_gmem0] [get_bd_intf_pins memory_subsystem/S04_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets krnl_vadd_1_m_axi_gmem0] [get_bd_intf_pins System_DPA/MON_M_AXI] [get_bd_intf_pins memory_subsystem/S04_AXI]
  connect_bd_intf_net -intf_net krnl_vadd_1_m_axi_gmem1 [get_bd_intf_pins krnl_vadd_1/m_axi_gmem1] [get_bd_intf_pins memory_subsystem/S05_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets krnl_vadd_1_m_axi_gmem1] [get_bd_intf_pins System_DPA/MON_M_AXI1] [get_bd_intf_pins memory_subsystem/S05_AXI]
  ...
  connect_bd_intf_net -intf_net slr0_M01_AXI [get_bd_intf_pins krnl_vadd_1/s_axi_control] [get_bd_intf_pins slr0/M01_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets slr0_M01_AXI] [get_bd_intf_pins System_DPA/MON_S_AXI] [get_bd_intf_pins slr0/M01_AXI]
  ...
  connect_bd_net -net slr0_peripheral_aresetn [get_bd_pins System_DPA/trace_rst] [get_bd_pins krnl_vadd_1/ap_rst_n] [get_bd_pins slr0/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x004000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces krnl_vadd_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S04_AXI/M00_AXI_MEM00] -force
  assign_bd_address -offset 0x004800000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces krnl_vadd_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S05_AXI/M02_AXI_MEM00] -force
  ...
  assign_bd_address -offset 0x1C050000 -range 0x00010000 -target_address_space [get_bd_addr_spaces userpf_control_M_AXI] [get_bd_addr_segs krnl_vadd_1/s_axi_control/Reg] -force
  ...
  exclude_bd_addr_seg -offset 0x000400000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces krnl_vadd_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S04_AXI/M01_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x004800000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces krnl_vadd_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S04_AXI/M02_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x004C00000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces krnl_vadd_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S04_AXI/M03_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x005000000000 -range 0x00020000 -target_address_space [get_bd_addr_spaces krnl_vadd_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S04_AXI/PLRAM_MEM00]
  exclude_bd_addr_seg -offset 0x005000020000 -range 0x00020000 -target_address_space [get_bd_addr_spaces krnl_vadd_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S04_AXI/PLRAM_MEM01]
  exclude_bd_addr_seg -offset 0x005000040000 -range 0x00020000 -target_address_space [get_bd_addr_spaces krnl_vadd_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S04_AXI/PLRAM_MEM02]
  exclude_bd_addr_seg -offset 0x004000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces krnl_vadd_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S05_AXI/M00_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x000400000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces krnl_vadd_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S05_AXI/M01_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x004C00000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces krnl_vadd_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S05_AXI/M03_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x005000000000 -range 0x00020000 -target_address_space [get_bd_addr_spaces krnl_vadd_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S05_AXI/PLRAM_MEM00]
  exclude_bd_addr_seg -offset 0x005000020000 -range 0x00020000 -target_address_space [get_bd_addr_spaces krnl_vadd_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S05_AXI/PLRAM_MEM01]
  exclude_bd_addr_seg -offset 0x005000040000 -range 0x00020000 -target_address_space [get_bd_addr_spaces krnl_vadd_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S05_AXI/PLRAM_MEM02]
