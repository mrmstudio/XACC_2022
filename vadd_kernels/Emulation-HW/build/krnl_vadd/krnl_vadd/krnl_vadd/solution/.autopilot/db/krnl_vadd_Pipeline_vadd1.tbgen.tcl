...
set C_modelArgList {
	...
	{ trunc_ln51_3 int 31 regular  }
	{ sext_ln51 int 62 regular  }
	{ sext_ln51_1 int 62 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[ {"cElement": [{"cName": "in1","offset": { "type": "dynamic","port_name": "in1","bundle": "control"},"direction": "READONLY"},{"cName": "in2","offset": { "type": "dynamic","port_name": "in2","bundle": "control"},"direction": "READONLY"},{"cName": "out_r","offset": { "type": "dynamic","port_name": "out_r"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "trunc_ln51_3", "interface" : "wire", "bitwidth" : 31, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln51", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln51_1", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln51_2 sc_in sc_lv 62 signal 1 } 
	{ trunc_ln51_3 sc_in sc_lv 31 signal 2 } 
	{ sext_ln51 sc_in sc_lv 62 signal 3 } 
	{ sext_ln51_1 sc_in sc_lv 62 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "trunc_ln51_3", "direction": "in", "datatype": "sc_lv", "bitwidth":31, "type": "signal", "bundle":{"name": "trunc_ln51_3", "role": "default" }} , 
 	{ "name": "sext_ln51", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln51", "role": "default" }} , 
 	{ "name": "sext_ln51_1", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln51_1", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "8267", "EstimateLatencyMax" : "8267",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			...
			{"Name" : "trunc_ln51_3", "Type" : "None", "Direction" : "I"},
			{"Name" : "sext_ln51", "Type" : "None", "Direction" : "I"},
			{"Name" : "sext_ln51_1", "Type" : "None", "Direction" : "I"}],
		"Loop" : [
...
set ArgLastReadFirstWriteLatency {
	krnl_vadd_Pipeline_vadd1 {
		gmem {Type IO LastRead 72 FirstWrite 74}
		sext_ln51_2 {Type I LastRead 0 FirstWrite -1}
		trunc_ln51_3 {Type I LastRead 0 FirstWrite -1}
		sext_ln51 {Type I LastRead 0 FirstWrite -1}
		sext_ln51_1 {Type I LastRead 0 FirstWrite -1}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "8267", "Max" : "8267"}
	, {"Name" : "Interval", "Min" : "8267", "Max" : "8267"}
]}
...
set Spec2ImplPortList { 
	...
	trunc_ln51_3 { ap_none {  { trunc_ln51_3 in_data 0 31 } } }
	sext_ln51 { ap_none {  { sext_ln51 in_data 0 62 } } }
	sext_ln51_1 { ap_none {  { sext_ln51_1 in_data 0 62 } } }
}
