...
((char*)__xlx_apatb_param_in1)[j*4+3] = gmem_pc_buffer[i].range(31, 24).to_int64();
            ...
            for (int j = 0, e = 1; j < e; j += 1, ++i) {((char*)__xlx_apatb_param_in2)[j*4+0] = gmem_pc_buffer[i].range(7, 0).to_int64();
((char*)__xlx_apatb_param_in2)[j*4+1] = gmem_pc_buffer[i].range(15, 8).to_int64();
((char*)__xlx_apatb_param_in2)[j*4+2] = gmem_pc_buffer[i].range(23, 16).to_int64();
((char*)__xlx_apatb_param_in2)[j*4+3] = gmem_pc_buffer[i].range(31, 24).to_int64();
}
