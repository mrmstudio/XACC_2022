...
extern "C" void krnl_idct_hw_stub_wrapper(volatile void *, volatile void *, volatile void *, int, int);
...
// print gmem1 Transactions
{
  ...
  {  __xlx_offset_byte_param_q = 0*64;
...
// print block Transactions
{
  ...
  {
    sc_bv<64> __xlx_tmp_lv = __xlx_offset_byte_param_block;

    std::string s(__xlx_tmp_lv.to_string(SC_HEX));
    aesl_fh.write(AUTOTB_TVIN_block, s.append("\n")); 
  }
...
// print q Transactions
{
  ...
  {
    sc_bv<64> __xlx_tmp_lv = __xlx_offset_byte_param_q;

    std::string s(__xlx_tmp_lv.to_string(SC_HEX));
    aesl_fh.write(AUTOTB_TVIN_q, s.append("\n")); 
  }
...
// print voutp Transactions
{
  ...
  {
    sc_bv<64> __xlx_tmp_lv = __xlx_offset_byte_param_voutp;

    std::string s(__xlx_tmp_lv.to_string(SC_HEX));
    aesl_fh.write(AUTOTB_TVIN_voutp, s.append("\n")); 
  }
...
// print ignore_dc Transactions
{
  ...
  aesl_fh.write(AUTOTB_TVIN_ignore_dc, __xlx_sprintf_buffer.data());
  {
    ...
    std::string s(__xlx_tmp_lv.to_string(SC_HEX));
    aesl_fh.write(AUTOTB_TVIN_ignore_dc, s.append("\n")); 
  }
...
// print blocks Transactions
{
  ...
  aesl_fh.write(AUTOTB_TVIN_blocks, __xlx_sprintf_buffer.data());
  {
    ...
    std::string s(__xlx_tmp_lv.to_string(SC_HEX));
    aesl_fh.write(AUTOTB_TVIN_blocks, s.append("\n")); 
  }
...
krnl_idct_hw_stub_wrapper(__xlx_apatb_param_block, __xlx_apatb_param_q, __xlx_apatb_param_voutp, __xlx_apatb_param_ignore_dc, __xlx_apatb_param_blocks);
