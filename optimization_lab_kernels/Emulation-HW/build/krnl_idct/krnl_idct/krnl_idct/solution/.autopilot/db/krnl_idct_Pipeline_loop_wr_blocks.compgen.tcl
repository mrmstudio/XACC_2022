...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln297 \
    op interface \
    ports { sext_ln297 { I 58 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_ivoutp \
    op interface \
    ports { ivoutp_dout { I 512 vector } ivoutp_empty_n { I 1 bit } ivoutp_read { O 1 bit } } \
} "
}
...
set InstName krnl_idct_flow_control_loop_pipe_sequential_init_U
set CompName krnl_idct_flow_control_loop_pipe_sequential_init
