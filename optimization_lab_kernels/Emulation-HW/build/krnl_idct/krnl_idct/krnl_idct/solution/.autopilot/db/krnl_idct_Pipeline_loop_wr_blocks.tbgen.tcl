set moduleName krnl_idct_Pipeline_loop_wr_blocks
set isTopModule 0
...
set C_modelName {krnl_idct_Pipeline_loop_wr_blocks}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem2 int 512 regular {axi_master 1}  }
	{ sext_ln297 int 58 regular  }
	{ mul_i_i int 32 regular  }
	{ ivoutp int 512 regular {fifo 0 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 512, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "voutp","offset": { "type": "dynamic","port_name": "voutp","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln297", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
 	{ "Name" : "mul_i_i", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "ivoutp", "interface" : "fifo", "bitwidth" : 512, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ ivoutp_dout sc_in sc_lv 512 signal 3 } 
	{ ivoutp_empty_n sc_in sc_logic 1 signal 3 } 
	{ ivoutp_read sc_out sc_logic 1 signal 3 } 
	...
	{ sext_ln297 sc_in sc_lv 58 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ivoutp_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "ivoutp", "role": "dout" }} , 
 	{ "name": "ivoutp_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "ivoutp", "role": "empty_n" }} , 
 	{ "name": "ivoutp_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "ivoutp", "role": "read" }} , 
 	...
 	{ "name": "sext_ln297", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "sext_ln297", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln297 { ap_none {  { sext_ln297 in_data 0 58 } } }
	mul_i_i { ap_none {  { mul_i_i in_data 0 32 } } }
	ivoutp { ap_fifo {  { ivoutp_dout fifo_data 0 512 }  { ivoutp_empty_n fifo_status 0 1 }  { ivoutp_read fifo_update 1 1 } } }
}
