set moduleName krnl_idct_Pipeline_loop_rd_blocks1
set isTopModule 0
...
set C_modelName {krnl_idct_Pipeline_loop_rd_blocks1}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem0 int 512 regular {axi_master 0}  }
	{ sext_ln223 int 58 regular  }
	{ mul_i_i int 32 regular  }
	{ iblock int 512 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "block_r","offset": { "type": "dynamic","port_name": "block_r"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln223", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
 	{ "Name" : "mul_i_i", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "iblock", "interface" : "fifo", "bitwidth" : 512, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ iblock_din sc_out sc_lv 512 signal 3 } 
	{ iblock_full_n sc_in sc_logic 1 signal 3 } 
	{ iblock_write sc_out sc_logic 1 signal 3 } 
	{ sext_ln223 sc_in sc_lv 58 signal 1 } 
	{ mul_i_i sc_in sc_lv 32 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "iblock_din", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "iblock", "role": "din" }} , 
 	{ "name": "iblock_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "iblock", "role": "full_n" }} , 
 	{ "name": "iblock_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "iblock", "role": "write" }} , 
 	{ "name": "sext_ln223", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "sext_ln223", "role": "default" }} , 
 	{ "name": "mul_i_i", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "mul_i_i", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln223 { ap_none {  { sext_ln223 in_data 0 58 } } }
	mul_i_i { ap_none {  { mul_i_i in_data 0 32 } } }
	iblock { ap_fifo {  { iblock_din fifo_data 1 512 }  { iblock_full_n fifo_status 0 1 }  { iblock_write fifo_update 1 1 } } }
}
